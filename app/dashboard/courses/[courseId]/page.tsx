...
const courseContent: { [key: string]: any } = {
  ...
  'ECR-001': {
    ...
    modules: [
      ...
      {
        id: 'M2',
        title: 'Emotion Recognition Techniques',
        type: 'reading',
        duration: 20,
        description: 'Learn to identify your emotional states'
      },
      {
        id: 'M3',
        ...
        type: 'exercise',
        duration: 30,
        description: 'Practical exercises for emotional control'
      }
    ]
  },
  'BPH-001': {
    ...
    modules: [
      ...
      {
        id: 'M2',
        title: 'Pattern Recognition Methods',
        type: 'reading',
        duration: 20,
        description: 'Techniques for identifying your patterns'
      },
      {
        id: 'M3',
        ...
        type: 'exercise',
        duration: 25,
        description: 'Analyze your own trading patterns'
      }
    ]
  }
};
      ...
      <div className="container mx-auto py-8">
        <div className="text-center">
          ...
          <p className="text-muted-foreground mb-4">
            The course "{params.courseId}" could not be found.
          </p>
