...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("AI Coach API called with:", { message, context })
...
9. If discussing emotional challenges, provide coping strategies
10. Always prioritize the trader's mental health and wellbeing`
