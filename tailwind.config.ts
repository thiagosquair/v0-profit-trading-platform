...
const config: Config = {
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        "gradient-navy-royal": "linear-gradient(135deg, hsl(var(--navy-600)) 0%, hsl(var(--royal-blue-500)) 100%)",
        "gradient-navy-royal-light": "linear-gradient(135deg, hsl(var(--navy-50)) 0%, hsl(var(--royal-blue-50)) 100%)",
      },
    },
  },
  plugins: [],
