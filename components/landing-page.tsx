...
<section
  ...
  style={{ backgroundImage: `url("/images/dis5.png")` }}
>
  <div className="container mx-auto">
...
// Short footer disclaimer component
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-start space-x-2 mb-3">
          ...
          <p className="text-xs text-gray-600">
            <strong className="text-red-600">Risk Warning:</strong> Trading involves substantial risk of loss. 
            MaXTrades is an educational platform and does not provide financial advice or guarantee trading success. 
            Most traders lose money. Never trade with money you cannot afford to lose.
          </p>
        </div>
        ...
        <div className="flex flex-wrap items-center justify-between text-xs text-gray-500">
          <div className="flex flex-wrap items-center space-x-4 mb-2 sm:mb-0">
            <span>© 2024 MaXTrades. All rights reserved.</span>
            <Link 
              href="/disclaimer" 
...
// Minimal footer disclaimer (even shorter)
export function MinimalFooterDisclaimer() {
  return (
    <div className="bg-red-50 border-t border-red-200 py-2 px-4">
      <div className="max-w-7xl mx-auto flex items-center justify-between text-xs">
        <div className="flex items-center space-x-2">
          <AlertTriangle className="h-3 w-3 text-red-500" />
          <span className="text-red-700">
            <strong>Risk Warning:</strong> Trading involves substantial risk. Educational content only.
          </span>
        </div>
        <Link 
          href="/disclaimer" 
...
export function StickyFooterDisclaimer() {
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-red-600 text-white py-2 px-4 z-50">
      <div className="max-w-7xl mx-auto flex items-center justify-between text-xs">
        <div className="flex items-center space-x-2">
          <AlertTriangle className="h-3 w-3" />
          <span>
            <strong>Risk Warning:</strong> Trading involves substantial risk of loss. Educational platform only.
          </span>
        </div>
        <div className="flex items-center space-x-3">
          ...
          <button 
            ...
            onClick={() => {
              // Hide the sticky disclaimer
              const element = document.querySelector('[data-sticky-disclaimer]')
...
// Trading page specific footer disclaimer
export function TradingPageFooterDisclaimer() {
  return (
    <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 mt-6">
      <div className="flex items-start space-x-2">
        <AlertTriangle className="h-4 w-4 text-yellow-600 mt-0.5" />
        <div className="text-sm text-yellow-800">
          <p className="font-medium mb-1">Important Trading Disclaimer</p>
          <p>
            This page contains educational content about trading psychology and risk management. 
            MaXTrades does not provide financial advice or trading recommendations. All trading 
            decisions are your responsibility. Consult qualified financial professionals before investing.
          </p>
          <Link 
            href="/disclaimer" 
            className="text-yellow-700 hover:text-yellow-900 underline text-xs mt-1 inline-block"
          >
